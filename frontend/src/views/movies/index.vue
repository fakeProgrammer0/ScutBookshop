<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" border fit style="width: 100%">
      <el-table-column :index="indexMethod" type="index" align="center"/>
      <el-table-column prop="rank" label="豆瓣排名" width="100" align="center"/>
      ...
      <el-table-column prop="score" label="豆瓣评分" width="100" align="center"/>
